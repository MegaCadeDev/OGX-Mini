...
namespace XboxOne
{
    ...
    // Button bitfield for InReport.buttons (uint16_t)
    // Order matches Linux evdev / GamepadTester / official Xbox One controller:
    // B0=A, B1=B, B2=X, B3=Y, B4=LB, B5=RB, B6=LT, B7=RT, B8=Select, B9=Start,
    // B10=L3, B11=R3, B12=DPAD_UP, B13=DPAD_DOWN, B14=DPAD_LEFT, B15=DPAD_RIGHT. (B16=Home separate.)
